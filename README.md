...
본 프로젝트는 산업용 표준 프로토콜인 OPC UA를 활용하여 하드웨어 데이터를 ASP.NET Core 애플리케이션과 연동하고, 시스템을 실시간으로 모니터링 및 제어하는 통합 솔루션을 구축하는 것을 목표로 합니다.

📅 개발 히스토리
2026-01-12: OPC UA - ASP.NET 연결 프레임워크 구축
서버 환경 설정: KEPServerEX를 활용하여 Modbus 장치와 OPC UA 클라이언트 간의 브리지 환경을 설정하였습니다.
